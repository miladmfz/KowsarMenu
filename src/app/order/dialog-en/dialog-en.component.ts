...
@Component({
  selector: 'app-dialog-en',
  templateUrl: './dialog-en.component.html',
  styleUrls: ['./dialog-en.component.css']
})
export class DialogEnComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogEnComponent>,
